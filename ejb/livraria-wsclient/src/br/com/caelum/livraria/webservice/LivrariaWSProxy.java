...
public class LivrariaWSProxy implements br.com.caelum.livraria.webservice.LivrariaWS {
  ...
  public br.com.caelum.livraria.webservice.Livro[] getLivrosPorTitulo(java.lang.String arg0) throws java.rmi.RemoteException{
    if (livrariaWS == null)
      _initLivrariaWSProxy();
    return livrariaWS.getLivrosPorTitulo(arg0);
  }
